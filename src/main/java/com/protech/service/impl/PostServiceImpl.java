...
public class PostServiceImpl implements PostService {
	...
	@Override
	public Post createNewPost(PostDto newPostForm, HttpSession session) {
	...
	@Override
	public Map<String, Object> findPostsListBySearch(String searchKey, int currPage, int pageSize) {
		List<Post> posts = this.postMapper.findPostsBySearch(searchKey);
		PageInfo<Post> postsPageInfo = new PageInfo<>(posts);
		// find categories
		List<Category> categories = this.categoryMapper.findAll();
		// construct attributes map
